...
var completeEditTask = function(taskName, taskType, taskId) {
    ...
    // loop through tasks array and task object with new contect
...
var loadTasks = function() {
    ...
    for (var i = 0; i < tasks.length; i++) {
        ...
        // keep task IDs in sync by reassigning
        tasks.id = taskIdCounter;
        console.log(tasks[i]);

        // create the li to store array data into attribute data
        var listItemEl = document.createElement("li");
        listItemEl.className = "task-item";
        listItemEl.setAttribute("data-task-id", tasks[i].id);
        listItemEl.setAttribute("draggable","true");

        // creates the html of the li data within a div 
        var taskInfoEl = document.createElement("div");
        taskInfoEl.className = "task-info";
        taskInfoEl.innerHTML = "<h3 class='task-name'>" + tasks[i].name + "</h3><span class='task-type'>" + tasks[i].type + "</span>";

        // appends the li with the divs
        listItemEl.appendChild(taskInfoEl);
